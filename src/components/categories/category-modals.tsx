 ...
 */
export const CreateCategoryModal = React.memo<CreateCategoryModalProps>(
 ...
 */
export const EditCategoryModal = React.memo<EditCategoryModalProps>(
  ({ isOpen, category, isUpdating, onClose, onSubmit }) => {
    const modalRef = useRef<HTMLDivElement>(null);
    const firstInputRef = useRef<HTMLInputElement>(null);
...
interface DeleteConfirmModalProps extends BaseModalProps {
  /** Category name being deleted (for confirmation text) */
  categoryName?: string;
...
/**
 * DeleteConfirmModal - Modal for confirming category deletion
 */
export const DeleteConfirmModal = React.memo<DeleteConfirmModalProps>(
  ({ isOpen, categoryName, isDeleting, onClose, onConfirm }) => {
    const modalRef = useRef<HTMLDivElement>(null);
        ...
        <div
          ...
          <div className="mb-6">
            <p className="text-sm text-gray-600">
              ...
              {categoryName ? `"${categoryName}"` : "this category"}? This
